...
async function installCcacheLinux(): Promise<void> {
  ...
  throw Error(
    "Can't install ccache automatically under this platform, please install it yourself before using this action.",
  );
}
...
async function installSccacheLinux(): Promise<void> {
  await installSccacheFromGitHub(
    ...
    '6af16d6d28e4247b8fcfea494463d4c52a129a9bb7db814e87c8e5918d73610a',
    '/usr/local/bin/',
    'sccache',
  );
}
...
async function installCcacheFromGitHub(
  version: string,
  artifactName: string,
  binSha256: string,
  binDir: string,
...
async function installSccacheFromGitHub(
  version: string,
